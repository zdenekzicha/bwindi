...
" id="helpMe">Pomůžeš mi?</a>
	...
	-->
		...
		<div id="right">
			...
			<h3>Chodím do Buhoma <?php echo $_smarty_tpl->tpl_vars['dite']->value['skola'];?>
, <?php if ($_smarty_tpl->tpl_vars['dite']->value['rocnik']!=''){?><?php echo $_smarty_tpl->tpl_vars['dite']->value['rocnik'];?>
 ročník<?php }?> <?php if ($_smarty_tpl->tpl_vars['dite']->value['vek']!=0){?><br /> je mi <?php echo $_smarty_tpl->tpl_vars['dite']->value['vek'];?>
 let<?php }?></h3>
