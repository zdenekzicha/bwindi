...
function dgwt_nbsp_get_registered_settings() {
    ...
    $dgwt_nbsp_settings = array(
        ...
        'general' => apply_filters('dgwt_nbsp_settings_general', array(
            ...
            'keep_together_numbers' => array(
                'id' => 'keep_together_numbers',
                'name' => __("Keep numbers together", 'automatic-nbsp'),
                'desc' => __("Replace <code>299 792 458 m/s</code> on <code>299&amp;nbsp;792&amp;nbsp;458&amp;nbsp;m/s</code> or <code>320 km/h</code> on <code>320&amp;nbsp;km/h</code>", 'automatic-nbsp'),
                'type' => 'checkbox',
                'std' => '0'
            )
                )
