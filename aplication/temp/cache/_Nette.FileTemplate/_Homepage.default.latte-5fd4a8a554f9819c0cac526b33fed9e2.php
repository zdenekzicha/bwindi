<?php //netteCache[01]000366a:2:{s:4:"time";s:21:"0.43118600 1358799869";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:77:"/Applications/MAMP/htdocs/Bwindy/sandbox/app/templates/Homepage/default.latte";i:2;i:1358798220;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"b7f6732 released on 2013-01-01";}}}?><?php

// source file: /Applications/MAMP/htdocs/Bwindy/sandbox/app/templates/Homepage/default.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'b1xg84dybf')
;
// prolog NUIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbfd07e1c1d9_content')) { function _lbfd07e1c1d9_content($_l, $_args) { extract($_args)
?><div id="banner">
...
<div id="content">
	...
	<section id="template">
		<h2>This page template located at <span><?php echo NTemplateHelpers::escapeHtml(strstr($presenter->template->getFile(), 'app'), ENT_NOQUOTES) ?></span></h2>

		<pre><code class="jush"><?php echo NTemplateHelpers::escapeHtml(file_get_contents($presenter->template->getFile()), ENT_NOQUOTES) ?></code></pre>
	</section>

	<section id="layout">
		<h2>Layout template located at <span><?php echo NTemplateHelpers::escapeHtml(strstr($template->getFile(), 'app'), ENT_NOQUOTES) ?></span></h2>

		<pre><code class="jush"><?php echo NTemplateHelpers::escapeHtml(file_get_contents($template->getFile()), ENT_NOQUOTES) ?></code></pre>
	</section>

	<section id="presenter">
		<h2>Current presenter located at <span><?php echo NTemplateHelpers::escapeHtml(strstr($presenter->reflection->fileName, 'app'), ENT_NOQUOTES) ?></span></h2>

		<pre><code class="jush-php"><?php echo NTemplateHelpers::escapeHtml(file_get_contents($presenter->reflection->fileName), ENT_NOQUOTES) ?></code></pre>
	</section>

	<footer>PHP <?php echo NTemplateHelpers::escapeHtml(PHP_VERSION, ENT_NOQUOTES) ?> |
		<?php if (isset($_SERVER['SERVER_SOFTWARE'])): ?>Server <?php echo NTemplateHelpers::escapeHtml($_SERVER['SERVER_SOFTWARE'], ENT_NOQUOTES) ;endif ?> |
		Nette Framework <?php echo NTemplateHelpers::escapeHtml(NFramework::VERSION, ENT_NOQUOTES) ?></footer>
</div>
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbf9ba53d9f4_title')) { function _lbf9ba53d9f4_title($_l, $_args) { extract($_args)
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lba7c72807a5_head')) { function _lba7c72807a5_head($_l, $_args) { extract($_args)
?><style>
